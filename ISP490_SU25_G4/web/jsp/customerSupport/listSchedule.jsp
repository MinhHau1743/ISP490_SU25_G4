                    ...
                    <section class="main-content-body">
                        <div class="calendar-toolbar">
                            ...
                            <div class="main-toolbar">
                                <button type="button" class="filter-button" id="filterToggleBtn">
                        ...
                        <form action="schedule" method="get" id="scheduleFilterForm">
                            <input type="hidden" name="action" value="listSchedule">
                            ...
                            <div class="filter-container" id="filterContainer" style="display: none;">
                                <div class="filter-controls">
                                    ...
                                    <div class="filter-group">
                                        <label for="type-filter">Loại lịch</label>
                                        <select id="type-filter" name="type" class="form-control">
                                            <option value="all" ${currentType eq 'all' ? 'selected' : ''}>Tất cả</option>
                                            <option value="request" ${currentType eq 'request' ? 'selected' : ''}>Yêu cầu kỹ thuật</option>
                                            <option value="campaign" ${currentType eq 'campaign' ? 'selected' : ''}>Lịch chiến dịch</option>
                                        </select>
                                    </div>
                                        ...
                                        <select id="status-filter" name="status" class="form-control">
                                            ...
                                            <c:forEach var="status" items="${statusList}">
                                                <option value="${status.id}" 
                                                        <c:if test="${currentStatus != null and currentStatus == status.id}">
                                                            selected
                                                        </c:if>>
                                                    ${status.statusName}
                                                </option>
