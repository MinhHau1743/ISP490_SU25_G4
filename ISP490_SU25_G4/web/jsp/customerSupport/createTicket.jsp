        ...
        <div class="app-container">
                        ...
                        <div class="main-column">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="enterpriseId" name="enterpriseId" class="form-control" required>
                                            ...
                                            <c:forEach var="customer" items="${customerList}"><option value="${customer.id}">${customer.name}</option></c:forEach>
                                            </select>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="sidebar-column">
                                <div class="detail-card sidebar-form">
                                    ...
                                    <div class="sidebar-form-row"><label for="priority">Mức độ ưu tiên</label><select id="priority" name="priority" class="form-control"><option>Thông thường</option><option selected>Cao</option><option>Khẩn cấp</option></select></div>
                                    ...
                                    <div class="sidebar-form-row"><label>Chi phí dự kiến</label><div class="radio-group"><label><input type="radio" name="isBillable" value="true"> Có</label><label><input type="radio" name="isBillable" value="false" checked> Không</label></div></div>
                                    <div id="amount-group" class="sidebar-form-row" style="display: none;"><label for="amount">Số tiền dự kiến (VND)</label><input type="number" id="amount" name="amount" class="form-control" value="0"></div>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    // Script đơn giản để thêm dòng thiết bị
