<%-- 
    Document   : addEmployeeStaff
    Created on : Jun 16, 2025, 9:46:31 PM
    Author     : NGUYEN MINH
--%>
...
<html lang="vi">
    <head>
        ...
        <title>Thêm nhân viên Bô phận văn phòng</title>
            ...
            <main class="main-content">
                ...
                <form action="addEmployee" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="form-card-grid">
                                        <div class="form-group">
                                            ...
                                            <select id="position" name="position"><option>Bô phận văn phòng</option></select>
                                        </div> 
                                        <div class="form-group">
                    ...
                    <footer class="page-actions-footer">
                        <a href="../admin/listEmployeeOffice.jsp" class="btn btn-secondary" role="button">Hủy</a>
