<%-- 
    Document   : addEmployeeTechnical
    Created on : Jun 16, 2025, 9:45:00 PM
    Author     : NGUYEN MINH
--%>
...
<html lang="vi">
    <head>
        ...
        <title>Thêm nhân viên Kỹ thuật</title>
            ...
            <main class="main-content">
                ...
                <form action="addEmployee" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="form-card-grid">
                                        <div class="form-group">
                                            ...
                                            <select id="position" name="position"><option>Kỹ thuật</option></select>
                                        </div> 
                                        <div class="form-group">
                    ...
                    <footer class="page-actions-footer">
                        <a href="../admin/listEmployeeTechnical.jsp" class="btn btn-secondary" role="button">Hủy</a>
