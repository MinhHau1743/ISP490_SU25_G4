<%-- 
    ...
    Created on : Jun 14, 2025, 1:26:29 PM
    Author     : NGUYEN MINH
--%>
...
<html lang="vi">
    <head>
        ...
        <title>Thêm nhân viên Chăm sóc khách hàng</title>
            ...
            <main class="main-content">
                ...
                <form action="addEmployee" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="form-card-grid">
                                        <div class="form-group">
                                            ...
                                            <select id="position" name="position"><option>Chăm sóc khách hàng</option></select>
                                        </div> 
                                        <div class="form-group">
                    ...
                    <footer class="page-actions-footer">
                        <a href="../admin/listEmployeeCustomer.jsp" class="btn btn-secondary" role="button">Hủy</a>
