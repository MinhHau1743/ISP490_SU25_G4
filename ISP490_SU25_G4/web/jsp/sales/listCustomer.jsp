...
<html lang="vi">
 ...
 /* Style for the new link on customer code */
 .data-table tbody td a {
 /* ĐÃ SỬA: Đổi màu xanh lá cây nhạt sang xanh lá cây đậm hơn (tương tự ảnh) */
 color: #1E7E34;
 ...
 <td>${customer.businessEmail}</td><td>${customer.hotline}</td><td>${customer.fullAddress}</td><td>${customer.assignedUsers [0].firstName}</td>
 <td>
