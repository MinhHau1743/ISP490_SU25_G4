...
/**
 * Controller duy nhất quản lý tất cả các hoạt động CRUD cho Hợp đồng. Đã được
 * cập nhật để lọc danh sách nhân viên phụ trách.
 *
 * @author YourName (Gộp từ 5 controller bởi Gemini)
 */
...
public class ContractController extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "create":
                    ...
                    break;
                case "save":
                    saveNewContract(request, response);
                    break;
                case "edit":
    ...
    private void viewContract(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    /**
     * Action: Hiển thị form để tạo hợp đồng mới. SỬA ĐỔI: Lọc danh sách nhân
     * viên chỉ lấy từ phòng "Chánh văn phòng".
     */
    private void showCreateForm(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // =======================================================
        List<User> employeeList = userDAO.getEmployeesByDepartment("Chánh văn phòng");
    ...
    private void saveNewContract(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
    ...
    /**
     * Action: Hiển thị form để chỉnh sửa hợp đồng. SỬA ĐỔI: Lọc danh sách nhân
     * viên chỉ lấy từ phòng "Chánh văn phòng".
     */
    ...
    private void updateContract(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            if (totalValueStr != null && !totalValueStr.isEmpty()) {
                ...
                contract.setTotalValue(BigDecimal.ZERO);
            }
